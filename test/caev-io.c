...
ctl_caev_pr(ctl_caev_t e)
{
	...
	d32tostr(buf, sizeof(buf), e.mktprc.a);
	printf("m: %d<-%u + %s  ", e.mktprc.r.p, e.mktprc.r.q, buf);
	d32tostr(buf, sizeof(buf), e.nomval.a);
	printf("n: %d<-%u + %s  ", e.nomval.r.p, e.nomval.r.q, buf);
	d32tostr(buf, sizeof(buf), e.outsec.a);
...
ctl_fund_pr(ctl_fund_t f)
{
	...
	d32tostr(buf, sizeof(buf), f.mktprc);
	printf("m: %s  ", buf);
	d32tostr(buf, sizeof(buf), f.nomval);
	printf("n: %s  ", buf);
	d32tostr(buf, sizeof(buf), f.outsec);
	printf("o: %s\n", buf);
	return;
}
